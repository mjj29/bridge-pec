...
at Level 5 \orange{9F} (given in {\it italics}) and hence alternatives are
...
\begin{itemize}
\item 10--15 points, not balanced, 5+ hearts, may contain a longer minor (possible canape) \orange{11C15}.
\end{itemize}
}
   ...
   \item 2\hearts/\spades = non-forcing; major-focused.
	...
	\item 2NT = F1, how good are your diamonds?
		...
		\item 3NT = 20-23 balanced
         ...
         \item 4\hearts/\spades = Swiss for no trumps \xref{sec:swiss}
   ...
   \item 3\diamonds promises 4 hearts or 4 spades
      ...
      \item 3N = 4--4 majors
         ...
         \item 4\spades = with 4 spades.
			\end{itemize}
		\item 4\clubs/\diamonds = Swiss \xref{sec:swiss} for no-trumps
		\end{itemize}
