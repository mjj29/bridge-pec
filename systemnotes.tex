...
Category 3 events (as a Red system) are provided in Section \ref{level3}.
...
\item 2x-(p)-relay-(X):
   \begin{itemize}
	...
	\item 2N (x = clubs) = 20-23 bal
	\item 2N (x \not= clubs) = GF, prefer cheaper suit
	\item Other of two suits = GF, prefer other suit
	\item Jump cheaper suit (x = clubs) = GF, prefer cheaper suit
   \end{itemize}
\item 2N-(x):
   \begin{itemize}
