...
\begin{itemize}
\item 12--15 balanced (4333, 4432, 5332). May include some semi-balanced hands esp. 5422.
\item 10--15, not balanced, no 5-card major or at most one 4-card major
\end{itemize}
...
\item Game forcing (3 losers) with $\spadesuit$ \& $\clubsuit$, 5--4 or better 
\end{itemize}
...
\item Game forcing (3 losers) with $\heartsuit$ \& $\diamondsuit$, 4--4 or better (usually 5--4)
...
Three level bids are natual, weak, preempts. Typically seven cards they may
be occasionally a good six (particularly at favourable and in clubs) or a bad eight.

\paragraph{Higher-level openings}
...
Shows a solid seven or eight card suit an nothing outside better than a queen.
