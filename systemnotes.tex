...
Third seat non-vulnerable (events with 7+ boards per round only):
\begin{itemize}
...
\begin{itemize}
\item 3$\clubsuit$ - 7 card preempt in diamonds \orange{11J8(a)}
\item 3$\diamondsuit$ - 7 card preempt in hearts \orange{11J8(a)}
\item 3$\heartsuit$ - 7 card preempt in spades \orange{11J8(a)}
\end{itemize}
...
Shows a 4-level preempt in either minor~\orange{11K3(d)}. Usually eight cards. 
...
In the case of the third-seat non-vulnerable 1NT showing 9--15 balanced
the responses are weak takeout.
