...
bid which describes the hand best. This main mean small deviations of strength, 
...
guide, however, so might not strictly apply to all hands. The hands will,
obviously, meet the extended rule of 25 in all cases.
...
\begin{tabular}{ll}
1$\clubsuit$  & 12--15 balanced or 10--15 unbalanced, no five-card major and \\
	 &at most one four-card major. \orange{11C11}\\
1$\diamondsuit$  & 16+; excludes balanced hands 24+ and game-forcing \\
	&two-suited hands. \orange{11C12}\\
1$\heartsuit$  & 10--15 unbalanced, with 4+ spades and additional constraints:\\
	 & first or second seat non-vulnerable, possible canape with  \\
	 & hearts, but 5+ spades if not holding 4+ hearts. \orange{11C14} \\
	 & Other positions, or vulnerable, 5+ spades and 0--3 hearts.\\
1$\spadesuit$  & 10--15 unbalanced, 5+ hearts, and 0--3 spades. \orange{11C14}\\
1NT & 9--11 balanced in first or second non-vulnerable \orange{11F3}; \\
	 & otherwise 10--15 unbalanced with 4+ in both majors. \orange{11F5}\\
\end{tabular}
...
\begin{tabular}{ll}
2$\clubsuit$  & weak with $\diamondsuit$, single suited \\
		& OR weak with $\heartsuit$\&$\spadesuit$, 4--4 or better \\
		& OR GF with $\heartsuit$\&$\spadesuit$. \orange{11G10}\\
2$\diamondsuit$  & weak with $\heartsuit$, single suited \\
	& OR weak with $\spadesuit$\&$\clubsuit$, 5+/4+ or better \\
	& OR GF with $\spadesuit$\&$\clubsuit$. \orange{11G10}\\
2$\heartsuit$  & weak with $\spadesuit$, single suited \\
		& OR weak with $\clubsuit$\&$\diamondsuit$, 4+/4+ \\
		& OR GF with $\clubsuit$\&$\diamondsuit$. \orange{11G10}\\
2$\spadesuit$  & weak with $\heartsuit$ and a minor \\
		& OR GF with $\heartsuit$ and a minor. 4+/4+. \orange{11G10}\\
2NT & weak with $\diamondsuit$\&$\spadesuit$, 4+/4+, \\
		& OR 24+ balanced \\
		& OR GF with $\diamondsuit$\&$\spadesuit$. \orange{11H8} \\
\end{tabular}
...
3NT & gambling. \orange{11K3} \\
Higher-level openings & natural. \\
4NT & specific ace-asking. \orange{11L1} \\
\end{tabular}
      ...
      \item Simple suit rebids are suction-style, showing either the suit above
         ...
         short $\spadesuit$. 2$\spadesuit$-3$\clubsuit$-3$\spadesuit$: short $\clubsuit$.).
			...
			\item After 1$\diamondsuit$-1$\spadesuit$ and showing suit(s) by opener, bidding 4$\clubsuit$/$\diamondsuit$
				is swiss \xref{sec:swiss} agreeing openers most recently bid suit, bidding one of the other suits below 
...
\item 2NT:
   ...
   \item 3$\clubsuit$/3$\heartsuit$ = transfer preference; stronger.
      ...
      \item A 3NT rebid shows 24+ balanced
         ...
         \item 3$\heartsuit$/$\spadesuit$ = Swiss for no trumps \xref{sec:swiss}
...
penalties and applies in all cases that a natural notrump bid is doubled for
penalties.
...
Unwarrented bids of an outside suit at the 5 level are Exclusion Blackwood.
...
(11-15, reasonable 6+ card suit). Also, after the sequence (Pass)-Pass-(1N).
