...
First, second or third seat non-vulnerable (events with 7+ boards per round only):
\begin{itemize}
\item 4+ hearts, may be longer spades or a minor (possible canape), but will always have 5 hearts or 4 spades.
\end{itemize}

All other positions and vulnerabilities:
\begin{itemize}
\item 5+ hearts, 0-3 spades, may contain a longer minor (possible canape).
\end{itemize}
...
10--15 points, not balanced. 5+ spades, 0-3 hearts \orange{11C15}, may have a longer minor (possible canape).
