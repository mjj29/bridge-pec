...
\item 2\diamonds:
   ...
   \item 2NT = F1, how good are your hearts?
	...
	\item 3\diamonds = GF enquiry
		...
		\item 4\clubs = weak, blacks, better clubs
		\end{itemize}
	\end{itemize}
...
\item 2\hearts:
   ...
   \item 2NT = F1, how good are your spades?
	...
	\item 3\hearts = GF enquiry
		...
		\item 4\clubs = weak, minors, better clubs
		\item 4\diamonds = weak, minors, better diamonds
		\end{itemize}
	\end{itemize}
...
or after 1\clubs--1\diamonds--1NT, all bids are natural and to play and
announced as "Natural, Non-forcing" \orange{4E5}.
...
shows 4-card support and a minimum. Announced with the suit transferred to \orange{4G2}.
...
should be used with any 4 or honour-third. Announced as "Diamonds" \orange{4G2}.
