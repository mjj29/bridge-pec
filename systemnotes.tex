...
Please note that the EBU does not recommend providing prepared defences to systems.
Nontheless, if you would find these useful here are some {\em simple} defences to our system. 
...
\item 2NT
	...
	\item 3$\spadesuit$/$\diamondsuit$ = asking for a stop for 3NT
	\end{itemize}
\end{itemize}
